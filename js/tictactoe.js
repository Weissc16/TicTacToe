...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            //If activePlayer is equal to 'X', the x.png i splaced in HTML
            select.style.backgroundImage = 'url("images/eagles.png")';
            //Active player may only be 'X' or 'O' so, if not 'X' it must be 'O'
        } else {
            //If activePlayer is equal to 'O', the o.png is placed in HTML
            select.style.backgroundImage = 'url("images/cowboys.png")';
        }
...
function checkWinConditions() {
    ...
    // X 3, 4, 5 condition.
    else if (arrayIncludes('3X', '4X', '5X')) { drawWinLine(50, 204, 558, 304) }
    // X 6, 7, 8 condition.
    ...
    //9 squares are selected the code executes.
        ...
        setTimeout(function () { resetGame90; }, 500);
    }
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        //This line indiciates where the start of lines y axis is.
        y1 = coordY1,
    ...
    function animateLineDrawing() {
        ...
        c.beginPath();
        //This method moves us to a starting points in our line.
        c.moveTo(x1, y1);
    ...
    animateLineDrawing();
    //This ine waits 1 second.  Then, clears canvas, resets game, and allows clicking again.
